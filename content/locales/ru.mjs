...
export default {
  terminal: {
    ...
    launchingGame: 'запускаю <span class="glow">{game}</span> в песочнице CRT-режима...',
    ...
    ssh: {
      ...
      failure: {
        ...
        persistent: {
          ...
          hint: '<span class="dim">кстати — может, попробуете: <span class="glow">ssh {sshTarget}</span></span>',
        },
      },
    },
    game: {
