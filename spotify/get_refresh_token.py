...
Run this ONCE, locally or on your VPS with a browser available (or just
open the printed URL on any device — it doesn't have to be the VPS).
...
def main():
    ...
    print("\n=== Your refresh token (save this to /etc/spotify-widget.env) ===\n")
    print(refresh_token)
    print()
