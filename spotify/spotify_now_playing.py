...
# Where to write the output JSON. Point this at a path your web server
# already serves as a static file (e.g. inside your site's public dir).
OUTPUT_PATH = os.environ.get("OUTPUT_PATH", "/var/www/nikita.sh/now-playing.json")
